...
namespace Vajra
{
  namespace runtime
  {
    ...
    struct WorkerRuntimeState
    {
      ...
      std::atomic<std::int64_t> http2_receive_nanoseconds{0};
      std::atomic<std::int64_t> http2_frame_precheck_nanoseconds{0};
      std::atomic<std::int64_t> http2_nghttp2_recv_nanoseconds{0};
      std::atomic<std::int64_t> http2_execution_enqueue_nanoseconds{0};
      std::atomic<std::int64_t> http2_execution_queue_wait_nanoseconds{0};
    ...
    void note_worker_http2_receive_time(std::int64_t nanoseconds);
    void note_worker_http2_frame_precheck_time(std::int64_t nanoseconds);
    void note_worker_http2_nghttp2_recv_time(std::int64_t nanoseconds);
    void note_worker_http2_execution_enqueue_time(std::int64_t nanoseconds);
    void note_worker_http2_execution_queue_wait_time(std::int64_t nanoseconds);
