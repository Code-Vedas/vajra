...
The scheduled `nghttp2 version` workflow runs
`scripts/check-nghttp2-version` and fails when this source tree no longer
matches the latest upstream release. When updating the vendored source, update
