  ...
  namespace
  {
    ...
    void test_build_maps_method_path_query_headers_and_socket_context()
    {
      ...
      const Vajra::request::RequestContext request_context{
          ...
          Vajra::request::SocketContext{"127.0.0.2", 54'321, "127.0.0.1", 3000, "http"}, Vajra::platform::kInvalidSocket, "", nullptr, nullptr};
    ...
    void test_build_rejects_unsupported_header_name_characters()
    {
      ...
      const Vajra::request::RequestContext request_context{
          ...
          Vajra::request::SocketContext{"127.0.0.1", 10'000, "127.0.0.1", 3000, "http"}, Vajra::platform::kInvalidSocket, "", nullptr, nullptr};
